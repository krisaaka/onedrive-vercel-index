...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'kris@locrayltd.onmicrosoft.com',
  ...
  email: 'mailto:kris@locrayltd.onmicrosoft.com',
